...
export interface TradeCalculatorRef {
  addItem: (fruitName: string, side: 'your' | 'their') => void;
  removeItem: (fruitName: string, side: 'your' | 'their') => void;
  resetCalculator: () => void;
}

export const TradeCalculator = forwardRef<TradeCalculatorRef, TradeCalculatorProps>(
  ({ isPermanent, onModeChange }, ref) => {
...
TradeCalculator.displayName = 'TradeCalculator';